...
@Table(name = "vet") // makes the connection with the table from the DB, basically we specify the name
public class Vet {

    @Id // PK
    @GeneratedValue(strategy = GenerationType.IDENTITY) // autoincrement
    @Column(name = "id") // makes the connection to the column in the DB
    private Long id;
